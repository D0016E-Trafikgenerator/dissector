...
--dofile("/plugins/coap.lua")

MYPROTO_SCRIPT_PATH="C:\\Program Files (x86)\\Wireshark\\plugins\\"
dofile(MYPROTO_SCRIPT_PATH.."Coapdissectorlua.lua")
--dofile(MYPROTO_SCRIPT_PATH.."coap.lua")